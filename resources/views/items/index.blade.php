        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/items/create') }}" class="btn btn-success btn-sm" title="Add New items">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add a new item
                        </a>
                        <br/>
                        <br/>
                        <div>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="col-md-4 px-0">
                                                    <img src="../uploads/items/{{ $item->photo }}" alt="{{ $item->photo }}" class="img-fluid">
                                                </div>
                                            </div>
                                        </td>
                                        <td>{{ $item->quantity }}</td>
